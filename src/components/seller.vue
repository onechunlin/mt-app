...
.seller {
	...
	.seller .seller-wrapper .seller-view .address-wrapper .address-right {
		flex: 0 0 60px;
		background: url(../assets/line.png) no-repeat left center;
	...
	.seller .seller-wrapper .seller-view .safety-wrapper {
		...
		background: url(../assets/safety.png) no-repeat left center;
		background-size: 14px 16px;
		font-size: 14px;
	}
	...
	.seller .seller-wrapper .tip-wrapper .delivery-wrapper {
		background: url(../assets/delivery.png) no-repeat left center;
		background-size: 14px 16px;
	...
	.seller .seller-wrapper .other-wrapper .server-wrapper {
		background: url(../assets/server.png) no-repeat left center;
		background-size: 15px 15px;

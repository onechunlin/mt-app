      ...
      <div class="content">
        <div class="rating-select" v-if="ratings.tab">
          ...
          <span 
            ...
            <img v-show="selectType != 0" src="../assets/icon_sub_tab_dp_normal@2x.png"/>
            <img v-show="selectType == 0" src="../assets/icon_sub_tab_dp_highlighted@2x.png"/>
        ...
        <ul class="rating-list">
            <li 
              ...
              <div class="comment-header">
                ...
                <img src="../assets/anonymity.png" v-if="!comment.user_pic_url"  />
              </div>
